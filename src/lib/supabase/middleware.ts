...
export async function updateSession(request: NextRequest) {
  try {
    ...
    if (!process.env.NEXT_PUBLIC_SUPABASE_URL || !process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY) {
      ...
      // If missing, we can't authenticate, just let the request pass through or handle it gracefully
    ...
    // Return a valid response to prevent MIDDLEWARE_INVOCATION_FAILED from crashing the whole app
